...
$(DOCKER_VNET_MONITOR)_PYTHON_WHEELS += $(SONIC_PY_COMMON_PY2) $(SWSSSDK_PY2)
$(DOCKER_VNET_MONITOR)_DEPENDS += $(LIBSWSSCOMMON) $(PYTHON_SWSSCOMMON)
$(DOCKER_VNET_MONITOR)_LOAD_DOCKERS += $(DOCKER_CONFIG_ENGINE_STRETCH)

ifeq ($(INCLUDE_VNET_MONITOR), y)
SONIC_DOCKER_IMAGES += $(DOCKER_VNET_MONITOR)
SONIC_STRETCH_DOCKERS += $(DOCKER_VNET_MONITOR)
