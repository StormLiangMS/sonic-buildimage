...
BRCM_SAI_DBG = libsaibcm-dbg_3.7.5.2-2_amd64.deb
$(eval $(call add_derived_package,$(BRCM_SAI),$(BRCM_SAI_DBG)))
$(BRCM_SAI_DBG)_URL = "https://sonicstorage.blob.core.windows.net/packages/bcmsai/3.7/libsaibcm-dbg_3.7.5.2-2_amd64.deb?sv=2015-04-05&sr=b&sig=11z%2BoTsxJkEzDRrZ7y7TKsGeKIl70Yhcd77Gnsy1pJw%3D&se=2034-11-12T07%3A39%3A07Z&sp=r"
