...
BRCM_SAI_DBG = libsaibcm-dbg_3.7.6.1_amd64.deb
$(eval $(call add_derived_package,$(BRCM_SAI),$(BRCM_SAI_DBG)))
$(BRCM_SAI_DBG)_URL = "https://sonicstorage.blob.core.windows.net/packages/bcmsai/3.7/libsaibcm-dbg_3.7.6.1_amd64.deb?sv=2015-04-05&sr=b&sig=67eMh6kqEi%2BZdjkJb7AEsflPJwFZV2uWTAM%2B4WUGIG8%3D&se=2035-04-16T00%3A59%3A30Z&sp=r"
