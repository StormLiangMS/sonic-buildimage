...
BRCM_SAI_DBG = libsaibcm-dbg_3.7.5.1_amd64.deb
$(eval $(call add_derived_package,$(BRCM_SAI),$(BRCM_SAI_DBG)))
$(BRCM_SAI_DBG)_URL = "https://sonicstorage.blob.core.windows.net/packages/bcmsai/3.7/libsaibcm-dbg_3.7.5.1_amd64.deb?sv=2015-04-05&sr=b&sig=WNM5qCU9ZHUDBQEs4X4k51PgXugPhZNdmTKvQzPX8wQ%3D&se=2034-02-15T03%3A54%3A34Z&sp=r"
