...
BRCM_SAI_DBG = libsaibcm-dbg_3.7.3.3-2_amd64.deb
$(eval $(call add_derived_package,$(BRCM_SAI),$(BRCM_SAI_DBG)))
$(BRCM_SAI_DBG)_URL = "https://sonicstorage.blob.core.windows.net/packages/bcmsai/3.7/libsaibcm-dbg_3.7.3.3-2_amd64.deb?sv=2015-04-05&sr=b&sig=r5lwJSB48k7ZP5jvarlGX%2FkNAkuoRmQruyV90kI7w8k%3D&se=2033-10-29T22%3A32%3A50Z&sp=r"
