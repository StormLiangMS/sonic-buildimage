...
BRCM_SAI_DBG = libsaibcm-dbg_3.7.6.1-1_amd64.deb
$(eval $(call add_derived_package,$(BRCM_SAI),$(BRCM_SAI_DBG)))
$(BRCM_SAI_DBG)_URL = "https://sonicstorage.blob.core.windows.net/packages/bcmsai/3.7/libsaibcm-dbg_3.7.6.1-1_amd64.deb?sv=2015-04-05&sr=b&sig=5xdsIXP9IJceNj%2Fq3766kAwlJiX5eDax1OjdP82n7tM%3D&se=2030-08-05T13%3A40%3A06Z&sp=r"
