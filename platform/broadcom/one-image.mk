...
$(SONIC_ONE_IMAGE)_INSTALLS += $(BRCM_OPENNSL_KERNEL) $(CISCO_N9200_PLATFORM_MODULE) $(CISCO_PYTHON_PLATFORM_MODULE)
...
# Commented out, To FIX N3k    $(CISCO_N3132_PLATFORM_MODULE)
